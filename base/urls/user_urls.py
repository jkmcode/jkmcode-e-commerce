...
urlpatterns = [
    ...
    path('reset_password/', views.requestPasswordResetEmail, name='reset_password'),
    path('password-reset/<uidb64>/<token>/', views.passwordTokenCheckAPI, name='password-reset-confirm'),
