...
from base.serializer import ProductSerializer, ProductSerializerImage, ProductSerializerImages, ProductSerializerImages2
...
def uploadImage(request):
    ...
    product.image = request.FILES.get('image')  #tutaj jest update zdjęcia
